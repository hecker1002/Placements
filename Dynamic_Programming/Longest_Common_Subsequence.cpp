...
Logic - since we can select any common elements of both the strings , we can select distonious elements also

Now , we have a choice to pick elements to form an lcs or not (choice and decisions)  and optimal soln (longest) is asked .
